...
namespace mirinae {
    ...
    public:
        ...
        bool enable_validation_layer() {
            if (!this->is_validation_layer_available()) {
    ...
    private:
        ...
        static bool is_validation_layer_available() {
            const auto available_layers = InstanceFactory::get_layers();
    ...
    public:
        VulkanInstance() {
            ...
            debug_messenger_ = this->create_debug_msger(instance_);
        }
    ...
    private:
        ...
        static VkDebugUtilsMessengerEXT create_debug_msger(VkInstance instance) {
