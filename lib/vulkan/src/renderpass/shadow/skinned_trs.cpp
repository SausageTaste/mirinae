...
namespace { namespace task {
    ...
    private:
        ...
        const mirinae::DebugLabel DEBUG_LABEL{
            "Shadow Skinned Trans", 0.38, 0.38, 0.38, 0.5
        };
...
namespace {
    ...
    class RpStatesShadowSkinnedTransp
        ...
        RpStatesShadowSkinnedTransp(
            ...
            // Pipeline
            {
                ...
                builder.shader_stages()
                    .add_vert(":asset/spv/shadow_skinned_trs_vert.spv")
                    .add_frag(":asset/spv/shadow_skinned_trs_frag.spv");
