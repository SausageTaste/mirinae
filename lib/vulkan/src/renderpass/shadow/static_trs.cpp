...
namespace { namespace task {
    ...
    private:
        ...
        const mirinae::DebugLabel DEBUG_LABEL{
            "Shadow Static Trans", 0.38, 0.38, 0.38
        };
...
namespace {
    ...
    public:
        RenderPass(
            ...
            // Pipeline layout
            {
                mirinae::PipelineLayoutBuilder{}
                    .desc(rp_res_.desclays_.get("gbuf:actor").layout())
                    .desc(rp_res_.desclays_.get("gbuf:model").layout())
                    .add_vertex_flag()
        ...
        ~RenderPass() override { this->destroy_render_pass_elements(device_); }
...
namespace mirinae::rp {
    ...
    std::unique_ptr<IRpBase> create_rp_shadow_static_trs(
